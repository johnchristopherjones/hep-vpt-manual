...
You'll need to download and install \href{http://www.rdesktop.org/}{rdesktop} for accessing Windows Termainal Services.  \noun{Rdesktop} is available through the package management systems of most distributions, such as Debian, Ubuntu, and Redhat.  A \href{http://www.gnome.org/}{Gnome} frontend to \noun{rdesktop} is also available, called \href{http://www.nongnu.org/grdesktop/}{grdesktop}.

% These directions assume rdesktop:
% \begin{enumerate}
% \item 
% \end{enumerate}
...
\item Close LabVIEW.
\item Click the start button and navigate to \menu{Start \menusep Logout}, then choose \menu{Power Off} when prompted.
\end{enumerate}
